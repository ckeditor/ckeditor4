...
CKEDITOR.plugins.setLang( 'a11yfirsthelp', 'en', {
  ...
  gettingStarted3Heading: 'A11yFirst Toolbar Features',
  gettingStarted3Content: [
    'Headings',
    'Block Format',
    'Inline Styles'
  ],     

  gettingStarted4Heading: 'Additional Resources',
  gettingStarted4Content: [
    'Item 1',
    'Item 2',
    'Item 3',
    'Item 4',
