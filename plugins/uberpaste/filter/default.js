...
( function() {
	...
	plug.rules = {
		...
		word: function( filter, editor, msoListsDetected ) {
			var invalidTags = [
					'o:p',
					'xml',
					'script',
	...
	plug.lists = {
		...
		numbering: {
			 ...
			 *
			 *		 var toNumber = CKEDITOR.plugins.uberpaste.lists.numbering.toNumber;
			 *
			 ...
			 * @returns {Number}
			 * @member CKEDITOR.plugins.uberpaste.lists.numbering
			 */
			 ...
			 *
			 *		var getStyle = CKEDITOR.plugins.uberpaste.lists.numbering.getStyle;
			 *
	...
	plug.images = {
		 ...
		 * @member CKEDITOR.plugins.uberpaste.images
		 */
		 ...
		 *
		 *		CKEDITOR.plugins.uberpaste.images.extractTagsFromHtml( html );
