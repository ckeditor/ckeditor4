...
CKEDITOR.plugins.add( 'forms', {
	...
	icons: 'button,checkbox,form,form-rtl,hiddenfield,hiddenfield-rtl,imagebutton,radio,select,select-rtl,textarea,textarea-rtl,textfield,textfield-rtl', // %REMOVE_LINE_CORE%
