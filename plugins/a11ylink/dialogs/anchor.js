...
CKEDITOR.dialog.add( 'anchor', function( editor ) {
	...
	return {
		title: editor.lang.a11ylink.anchor.title,
		minWidth: 300,
		minHeight: 60,
		onOk: function() {
		...
		contents: [ {
			id: 'info',
			label: editor.lang.a11ylink.anchor.title,
			accessKey: 'I',
			elements: [ {
				type: 'text',
				id: 'txtName',
				label: editor.lang.a11ylink.anchor.name,
				required: true,
				validate: function() {
					if ( !this.getValue() ) {
						alert( editor.lang.a11ylink.anchor.errorName ); // jshint ignore:line
						return false;
					}
					return true;
				}
