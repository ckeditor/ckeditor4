...
( function() {
	CKEDITOR.plugins.add( 'a11ylink', {
		...
		init: function( editor ) {
			...
			editor.addCommand( 'a11ylink', new CKEDITOR.dialogCommand( 'link', {
			...
			if ( editor.ui.addButton ) {
				...
				editor.ui.addButton( 'Unlink', {
					label: editor.lang.a11ylink.unlink,
					command: 'unlink',
					toolbar: 'links,20'
				} );
				editor.ui.addButton( 'Anchor', {
					label: editor.lang.a11ylink.anchor.toolbar,
					command: 'anchor',
					toolbar: 'links,30'
				} );
			}
			...
			if ( editor.addMenuItems ) {
				editor.addMenuItems( {
					anchor: {
						label: editor.lang.a11ylink.anchor.menu,
						command: 'anchor',
						group: 'anchor',
						order: 1
					},
					...
					removeAnchor: {
						label: editor.lang.a11ylink.anchor.remove,
					...
					link: {
						label: editor.lang.a11ylink.menu,
						command: 'link',
						group: 'link',
						order: 1
					},
			...
			// Need to set this for the origianl link plugin
			editor.plugins.link = editor.plugins.link || {};
			if (!editor.plugins.link.compiledProtectionFunction) {
				editor.plugins.link.compiledProtectionFunction = this.compiledProtectionFunction;
			}
		},
