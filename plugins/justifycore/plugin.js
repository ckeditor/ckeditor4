...
( function() {
	...
	function initCommands( editor ) {
		editor.addCommand( 'justifyleft', new justifyCommand( editor, 'justifyleft', 'left' ) );
		editor.addCommand( 'justifycenter', new justifyCommand( editor, 'justifycenter', 'center' ) );
		editor.addCommand( 'justifyright', new justifyCommand( editor, 'justifyright', 'right' ) );
		editor.addCommand( 'justifyblock', new justifyCommand( editor, 'justifyblock', 'justify' ) );

		editor.on( 'dirChanged', onDirChanged );
	}

	CKEDITOR.plugins.add( 'justifycore', {
