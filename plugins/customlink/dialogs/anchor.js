...
CKEDITOR.dialog.add('anchor', function(editor) {
  ...
  return {
    title: editor.lang.customlink.anchor.title,
    minWidth: 300,
    minHeight: 60,
    onOk: function() {
    ...
    contents: [
      {
        id: 'info',
        label: editor.lang.customlink.anchor.title,
        accessKey: 'I',
        elements: [
          {
            type: 'text',
            id: 'txtName',
            label: editor.lang.customlink.anchor.name,
            required: true,
            validate: function() {
              if (!this.getValue()) {
                alert(editor.lang.customlink.anchor.errorName); // jshint ignore:line
                return false;
              }
              return true;
            }
