...
CKEDITOR.plugins.add( 'simplebox', {
	...
	init: function( editor ) {
		...
		editor.widgets.add( 'simplebox', {
			...
			// * https://ckeditor.com/docs/ckeditor4/docs/#!/guide/dev_advanced_content_filter
			// * https://ckeditor.com/docs/ckeditor4/docs/#!/guide/plugin_sdk_integration_with_acf
			allowedContent:
			...
			//
			// Note: The "element" argument is an instance of https://ckeditor.com/docs/ckeditor4/docs/#!/api/CKEDITOR.htmlParser.element
