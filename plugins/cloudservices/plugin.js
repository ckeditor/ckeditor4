...
( function() {
	 ...
	 * To learn how to start using Easy Image check [CKEditor Cloud Services - Quick Start](https://docs.ckeditor.com/cs/latest/guides/quick-start.html) documentation.
	 *
	 * Note: make sure to set also the {@link CKEDITOR.config#cloudServices_tokenUrl} configuration option.
	 *
	 * ```js
	 ...
	 *
	 * You can find more information about token endpoints in [CKEditor Cloud Services - Quick Start](https://docs.ckeditor.com/cs/latest/guides/quick-start.html#create-token-endpoint)
	 * and [CKEditor Cloud Services - Creating token endpoint](https://docs.ckeditor.com/cs/latest/guides/token-endpoints/tokenendpoint.html) documentation.
	 *
