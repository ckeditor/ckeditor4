...
CKEDITOR.plugins.setLang( 'embedbase', 'fr', {
	...
	title: 'Média Intégré',
	button: 'Insérer le média intégré',
	unsupportedUrlGiven: 'L\'URL spécifiée n\'est pas supportée.',
	unsupportedUrl: 'L\'URL {url} n\'est pas supportée par Média Intégré',
	...
	fetchingMany: 'Récupération des réponse oEmbed, {current} sur {max} effectué...'
} );
