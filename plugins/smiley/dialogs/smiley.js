...
CKEDITOR.dialog.add( 'smiley', function( editor ) {
	...
	for ( i = 0; i < size; i++ ) {
		...
		html.push(
			...
			'<img class="cke_hand" title="', editor.lang.smiley[config.smiley_descriptions[i]], '"' +
			' cke_src="', CKEDITOR.tools.htmlEncode(config.smiley_path + images[i]), '" alt="', editor.lang.smiley[config.smiley_descriptions[i]], '"',
