...
( function() {
	...
	CKEDITOR.plugins.add( 'codesnippet', {
		...
		lang: 'bg,ca,cs,da,de,el,en,en-gb,eo,es,et,fa,fi,fr,fr-ca,hr,hu,it,ja,km,ku,lt,lv,nb,nl,no,pl,pt,pt-br,ro,ru,sk,sl,sq,sv,ta,th,tt,ug,uk,vi,zh-cn', // %REMOVE_LINE_CORE%
