							...
							children: [ {
								...
								children: [ {
									...
									validate: function() {
										...
										if ( !isValid ) {
											alert( editor.lang.common.invalidLength.replace( '%1', editor.lang.common.width ).replace( '%2', 'px, %' ) );
										} // jshint ignore:line
										return isValid;
									},
								...
								},
								{
									...
									validate: function() {
										var aMatch = this.getValue().match( regexGetSizeOrEmpty ),
											isValid = !!( aMatch && parseInt( aMatch[ 1 ], 10 ) !== 0 );
										if ( !isValid ) {
											alert( editor.lang.common.invalidLength.replace( '%1', editor.lang.common.height ).replace( '%2', 'px, %' ) );
										} // jshint ignore:line
										return isValid;
									},
									setup: setupDimension,
