...
CKEDITOR.plugins.setLang( 'a11yimage', 'en', {
	...
	typeInformativeHelp: 'Requires a short description and possibly a detailed description',
	typeDecorative: 'Decorative',
	typeDecorativeHelp: 'The image adds no additional information to the document',
	typeOfImage: 'Type of Image',
	hasDescription: 'Document includes detailed description',
	imageDesc: 'Accessible Description',
	captionContent: 'Caption Text',
	a11yfirstInfo: 'Info',
	a11yfirstInfoHelp: 'Learn about accessible images',
	descriptionLocation: 'Location of detailed description',
	descriptionHelp: 'When do I need a detailed description?',
	locationBefore: 'Before',
	locationBeforeHelp: 'Before the image',
	locationBeforeTitle: 'Detailed description is located just before the image',
	locationAfter:  'After',
	locationAfterHelp:  'After the image',
	locationAfterTitle: 'Detailed description is located just after the image',
	locationBoth:   'Before &amp; After',
	locationBothHelp:   'Both before and after the image',
	locationBothTitle: 'Detailed description is located just before and after the image',
	alignNone: 'None',
	alignLeft: 'Left',
	alignCenter: 'Center',
	alignRight: 'Right',
