...
( function( mod ) {
	...
	TextareaInput.prototype = copyObj( {
        ...
        '; outline: none; border-width: 0; outline: none; overflow: hidden; opacity: .05; filter: alpha(opacity=5);';
			...
			} // Work around Chrome issue (https://dev.ckeditor.com/ticket/2712)
			display.input.focus();
			if ( webkit ) {
	...
	function onFocus( cm ) {
		...
		if ( !cm.state.focused ) {
			...
			if ( !cm.curOp && cm.display.selForContextMenu != cm.doc.sel ) {
				...
				} // Issue https://dev.ckeditor.com/ticket/1730
			}
	...
	function hasBadBidiRects( measure ) {
		...
		if ( !r0 || r0.left == r0.right ) {
			return false;
		} // Safari returns null in some cases (https://dev.ckeditor.com/ticket/2780)
