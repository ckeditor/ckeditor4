	...
	accessibilityHelp: {
		...
		legend: [
			...
			items: [
				{
				name: 'סרגל הכלים',
				legend: 'לחץ על ${toolbarFocus} כדי לנווט לסרגל הכלים. ' +
				...
				legend: 'בתוך דיאלוג, לחץ טאב (TAB) כדי לנווט לשדה הבא, לחץ שיפט (SHIFT) + טאב (TAB) כדי לנווט לשדה הקודם, לחץ אנטר (ENTER) כדי לשלוח את הדיאלוג, לחץ אסקייפ (ESC) כדי לבטל. ' +
				...
				legend: 'לחץ ${contextMenu} או APPLICATION KEYכדי לפתוח את תפריט ההקשר. ' +
				...
				legend: 'בתוך תפריט צף, עבור לפריט הבא עם טאב (TAB) או חץ למטה. ' +
				...
				legend: 'לחץ ${elementsPathFocus} כדי לנווט לעץ האלמנטים. ' +
