...
CKEDITOR.lang[ 'ar' ] = {
	...
	common: {
		...
		editorHelp: 'اضغط على ALT + 0 للحصول على المساعدة.',
		...
		generalTab: 'عام',
		advancedTab: 'متقدم',
		validateNumberFailed: 'لا توجد نتيجة',
		confirmNewPage: 'ستفقد أي متغييرات إذا لم تقم بحفظها أولا. هل أنت متأكد أنك تريد صفحة جديدة؟',
		confirmCancel: 'بعض الخيارات قد تغيرت. هل أنت متأكد من إغلاق مربع النص؟',
		options: 'خيارات',
		target: 'هدف الرابط',
		targetNew: 'نافذة جديدة',
		targetTop: 'النافذة العليا',
