...
CKEDITOR.lang[ 'tr' ] = {
	...
	common: {
		...
		invalidCssLength: '"%1" alanı için verilen değer, geçerli bir CSS ölçü birimi (px, %, in, cm, mm, em, ex, pt, or pc) içeren veya içermeyen pozitif bir sayı olmalıdır.',
		...
		cssLengthTooltip: 'Piksel türünde bir sayı veya geçerli bir CSS ölçü birimi (px, %, in, cm, mm, em, ex, pt, or pc) içeren bir sayı girin.',
