...
( function( bender ) {
	...
	bender.tools = {
		...
		env: {
			...
			/* Tells whether current environment is running on a Windows. */
			windows: navigator.platform.toLowerCase().indexOf( 'win64' ) ||
					 navigator.platform.toLowerCase().indexOf( 'win32' ) ||
					 navigator.platform.toLowerCase().indexOf( 'win16' ) !== -1
		},
