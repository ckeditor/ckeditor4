	...
	bender.test( {
		...
		'test backspace #2': CKEDITOR.env.safari ? ignoreIt :
											b( '<p>x</p><p><strong>[]y</strong></p>',							[
																													...
																													'<p>x^<strong>y</strong></p>' // For WebKit (http://dev.ckeditor.com/ticket/13709).
																												] ),
		'test backspace #3': CKEDITOR.env.safari ? ignoreIt :
											b( '<p>x</p><p><a href="z">[]y</a></p>',							[
																													'<p>x<a href="z">^y</a></p>',
																													'<p>x^<a href="z">y</a></p>' // For WebKit (http://dev.ckeditor.com/ticket/13709).
																												] ),
		...
		'test backspace #9': CKEDITOR.env.safari ? ignoreIt :
											b( '<div><p><strong>f<em>oo</em></strong></p></div><blockquote><p><u>{}y</u></p></blockquote>',
																												[
																													...
																													'<div><p><strong>f<em>oo^</em></strong><u>y</u></p></div>' // For WebKit (http://dev.ckeditor.com/ticket/13709).
																												] ),
		...
		'test backspace, merge #2': CKEDITOR.env.safari ? ignoreIt :
										b( '<p><em id="x">x</em></p><p><em id="y">[]y</em></p>',			[
																												...
																												'<p><em id="x">x^</em><em id="y">y</em></p>' // For WebKit (http://dev.ckeditor.com/ticket/13709).
																											] ),
		'test backspace, merge #3': CKEDITOR.env.safari ? ignoreIt :
										b( '<p><a href="x">x</a></p><p><a href="y">[]y</a></p>',			[
																												'<p><a href="x">x</a><a href="y">^y</a></p>',
																												'<p><a href="x">x^</a><a href="y">y</a></p>' // For WebKit (http://dev.ckeditor.com/ticket/13709).
																											] ),
		...
		'test backspace, merge #8': CKEDITOR.env.safari ? ignoreIt :
										b( '<p><em style="color:red">x</em></p><p><em style="color:blue">[]y</em></p>',
																											[
																												...
																												'<p><em style="color:red">x^</em><em style="color:blue">y</em></p>' // For WebKit (http://dev.ckeditor.com/ticket/13709).
																											] ),
		...
		// Handled by list or table plugin or editable, but not related to http://dev.ckeditor.com/ticket/9998.
		// This is just to control whether the fix for http://dev.ckeditor.com/ticket/9998 does not break some case which it should not handle at all.
