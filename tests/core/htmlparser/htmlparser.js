...
( function() {
	...
	bender.test( {
		...
		// Attribute name may contains hypen and dot.(http://dev.ckeditor.com/ticket/4351)
		...
		// white-spaces before block-level elements are trimmed. (http://dev.ckeditor.com/ticket/4656)
		...
		// Attributes may have the < or > character. (http://dev.ckeditor.com/ticket/7513)
