...
( function() {
	...
	var tests = {
		...
		'test getTableElement': function() {
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_td1' ) ), 'collapsed td' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_th1' ) ), 'collapsed th' );

			// Normal range inside td.
			range = new CKEDITOR.dom.range( doc );
			range.selectNodeContents( doc.getById( '_td1' ).getFirst() );

			assert.isTrue( range.getTableElement().equals( doc.getById( '_td1' ) ), 'inside td' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_td1' ) ), 'partial inside td' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_td1' ) ), 'selected td' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_th1' ) ), 'selected th' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_thead' ) ), 'selected thead' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_tbody' ) ), 'selected tbody' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_tfoot' ) ), 'selected tfoot' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_table1' ) ), 'selected table1' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_tr2' ) ), 'selected 2 tds' );
			...
			assert.isNull( range.getTableElement(), 'selected 2 tds from different tables' );
			...
			assert.isNull( range.getTableElement(), 'selected 2 tables' );
			...
			assert.isNull( range.getTableElement(), 'selected paragraph' );
			...
			assert.isTrue( range.getTableElement().equals( doc.getById( '_td3' ) ), 'selected td in one-cell table' );
			...
			assert.isTrue( range.getTableElement( 'tbody' ).equals( doc.getById( '_tbody' ) ), 'filtering elements' );
		}
	};
