...
( function() {
	...
	bender.test( {
		...
		'test remove font size partialy from text': function() {
			...
			this.assertCombo( 'FontSize', '', false, bot, '<p>foo <span style="font-size:24px">bar</span>@</p>' );
		},
		...
		'test remove font family partially from text': function() {
			...
			this.assertCombo( 'Font', '', false, bot, '<p>foo <span style="' + ffArial + '">bar</span>@</p>' );
		},
