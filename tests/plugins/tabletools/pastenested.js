...
( function() {
	...
	var tests = {
		...
		'test paste 2x2 table into collapsed sel': createPasteTest( 'nested-2x1-2x2-caret', 'paste-2x2' ),
		'test paste 2x2 table into collapsed sel boundary': createPasteTest( 'nested-2x2-2x2-caret-boundary', 'paste-2x2' )
	};
