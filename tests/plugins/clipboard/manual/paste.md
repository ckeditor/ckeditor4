...
* There's no `text/html` data for external paste. Hence, pastebin is used. Hence, data type always equals `html` (see: [`config.clipboard_defaultContentType`](https://ckeditor.com/docs/ckeditor4/docs/#!/api/CKEDITOR.config-cfg-clipboard_defaultContentType)).
