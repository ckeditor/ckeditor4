            ...
            bender.editorBot.create( {
                ...
                bot.dialog( 'templates', function( dialog ) {
                    ...
                    setTimeout(function () {
                        ...
                        setTimeout(function () {
                            resume(function () {
                                assert.areEqual( '<h1>^I am a title</h1>', bot.htmlWithSelection(), 'Editor data has been replaced by the template.' );
                            });
                        }, 100);
                    }, 100);
                    wait();
            ...
            bender.editorBot.create( {
                ...
                bot.dialog( 'templates', function( dialog ) {
                    ...
                    setTimeout(function () {
                        ...
                        setTimeout(function () {
                            resume(function () {
                                assert.areEqual( '<h1>^I am a title</h1><p>I am a text</p>', bot.htmlWithSelection(), 'Editor data has been replaced by the template.' );
                            });
                        }, 100);
                    }, 100);
                    wait();
            ...
            bender.editorBot.create( {
                ...
                bot.dialog( 'templates', function( dialog ) {
                    ...
                    setTimeout(function () {
                        ...
                        setTimeout(function () {
                            resume(function () {
                                assert.areEqual( '<p>Lorem ipsum</p><h1>I am a title</h1><p>I am a text^</p>', bot.htmlWithSelection(), 'Template has been inserted.' );
                            });
                        }, 100);
                    }, 100);
            ...
            bender.editorBot.create({
                ...
                bot.dialog('templates', function (dialog) {
                    ...
                    setTimeout(function () {
                        ...
                        setTimeout(function () {
                            resume(function () {
                                assert.areEqual('<p>Lorem ipsum</p><p>I am a text</p><p>Here is some more text^</p>', bot.htmlWithSelection(), 'Template has been inserted.');
                            });
                        }, 100);
                    }, 100);
