		...
		'test dialog field updateStyle': function( source, expected ) {
			...
			bot.dialog( 'testAdvTab', function( dialog ) {
				...
				assert.isTrue(
					...
					style == 'border-bottom-color:red;border-bottom-width:1px;border-left-color:red;border-left-width:1px;border-right-color:red;border-right-width:1px;border-style:initial;border-top-color:red;border-top-width:1px;width:300px;' ||
					style == 'border-bottom-color:red;border-bottom-style:solid;border-bottom-width:1px;border-left-color:red;border-left-style:solid;border-left-width:1px;border-right-color:red;border-right-style:solid;border-right-width:1px;border-top-color:red;border-top-style:solid;border-top-width:1px;width:300px;'
				, style );
