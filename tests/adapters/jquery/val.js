...
bender.test( {
	...
	'test val() of multiple editors (http://dev.ckeditor.com/ticket/7876)': function() {
	...
	'test use val() as called with undefined (http://dev.ckeditor.com/ticket/9019)': function() {
