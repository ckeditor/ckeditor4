...
* [Severity: minor] Fixed XSS vulnerability in the HTML parser connected to the `srcdoc` attribute of the  `iframe`  element appearing only with [Iframe](http://ckeditor.com/addon/iframe) plugin and [Advanced Content Filter](http://docs.ckeditor.com/#!/guide/dev_acf) turned off. Reported by [Sriramk21](https://twitter.com/sriramk21) from Pegasystems.
* [Severity: minor] Fixed XSS vulnerability in the HTML parser connected to the `src` attribute of the `iframe` element appearing only with [Iframe](http://ckeditor.com/addon/iframe) plugin and [Advanced Content Filter](http://docs.ckeditor.com/#!/guide/dev_acf) turned off.
