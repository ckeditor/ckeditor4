...
* [#2935](https://github.com/ckeditor/ckeditor-dev/issues/2935): Added the [`CKEDITOR.config.pasteFromWord_keepEmptyMargins`](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_config.html#cfg-pasteFromWord_keepEmptyMargins) config option, that allows keeping any `margin-*: 0` style that would be otherwise removed when pasting with [Paste from Word](https://ckeditor.com/cke4/addon/pastefromword) plugin.
