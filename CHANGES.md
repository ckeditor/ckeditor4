...
* [#1176](https://github.com/ckeditor/ckeditor-dev/pull/1176): The [Baloon Toolbar](https://ckeditor.com/cke4/addon/balloontoolbar) can be attached to selection instead of element.
