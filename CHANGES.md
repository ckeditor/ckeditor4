...
* Updated [WebSpellChecker](https://ckeditor.com/cke4/addon/wsc) (WSC) plugin:
	* [#52](https://github.com/WebSpellChecker/ckeditor-plugin-wsc/issues/52) Fixed an issue where clicking "Finish Checking" without prior action would hang the Spell Checking dialog.
