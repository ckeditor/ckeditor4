...
* [#5234](https://github.com/ckeditor/ckeditor4/issues/5234): Fixed: While using [Easy Image](https://ckeditor.com/cke4/addon/easyimage), the file can't be uploaded using toolbar button.
